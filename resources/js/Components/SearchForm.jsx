        ...
        <form className="flex items-center max-w-xl shrink-0" onSubmit={onSubmit}>
            ...
            <div className="relative w-full">
                ...
                <input
                    type="text"
                    id="simple-search"
                    className="bg-base-200 border border-gray-300 text-base-content text-sm rounded-lg focus:ring-blue focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
